    ...
    window.getLocalizedArticleData = function(slug, lang) {
        ...
        try {
            ...
            if (foundCms) {
                ...
                var emptyBodyHtml = '<p class="text-base text-neutral-700 leading-relaxed font-light mb-4"><br></p>';

                // Get exact body for this language - DO NOT fallback to English body!
                var bodyContent = (langObj && langObj.body !== undefined && langObj.body !== null)
                    ? langObj.body
                    : (curLang === 'en' ? (foundCms.body || (foundCms.en && foundCms.en.body) || emptyBodyHtml) : emptyBodyHtml);

                var titleText = (langObj && langObj.title)
                    ? langObj.title
                    : (curLang === 'en' ? (foundCms.title || (foundCms.en && foundCms.en.title) || '') : '');

                var curFaqs = (langObj && Array.isArray(langObj.faqs) && langObj.faqs.length)
                    ? langObj.faqs
                    : (curLang === 'en' && Array.isArray(foundCms.faqs) && foundCms.faqs.length ? foundCms.faqs : []);

                // If no FAQs exist yet for this language, initialize with clean editable FAQ slots
                if (!Array.isArray(curFaqs) || !curFaqs.length) {
                    var defaultEmptyFaqs = {
                        ar: [
                            { q: 'انقر لتعديل السؤال الأول', a: 'انقر لتعديل إجابة السؤال الأول' },
                            { q: 'انقر لتعديل السؤال الثاني', a: 'انقر لتعديل إجابة السؤال الثاني' },
                            { q: 'انقر لتعديل السؤال الثالث', a: 'انقر لتعديل إجابة السؤال الثالث' },
                            { q: 'انقر لتعديل السؤال الرابع', a: 'انقر لتعديل إجابة السؤال الرابع' },
                            { q: 'انقر لتعديل السؤال الخامس', a: 'انقر لتعديل إجابة السؤال الخامس' },
                            { q: 'انقر لتعديل السؤال السادس', a: 'انقر لتعديل إجابة السؤال السادس' }
                        ],
                        fa: [
                            { q: 'برای ویرایش پرسش اول کلیک کنید', a: 'برای ویرایش پاسخ اول کلیک کنید' },
                            { q: 'برای ویرایش پرسش دوم کلیک کنید', a: 'برای ویرایش پاسخ دوم کلیک کنید' },
                            { q: 'برای ویرایش پرسش سوم کلیک کنید', a: 'برای ویرایش پاسخ سوم کلیک کنید' },
                            { q: 'برای ویرایش پرسش چهارم کلیک کنید', a: 'برای ویرایش پاسخ چهارم کلیک کنید' },
                            { q: 'برای ویرایش پرسش پنجم کلیک کنید', a: 'برای ویرایش پاسخ پنجم کلیک کنید' },
                            { q: 'برای ویرایش پرسش ششم کلیک کنید', a: 'برای ویرایش پاسخ ششم کلیک کنید' }
                        ],
                        zh: [
                            { q: '点击编辑常见问题 1', a: '点击编辑问题解答 1' },
                            { q: '点击编辑常见问题 2', a: '点击编辑问题解答 2' },
                            { q: '点击编辑常见问题 3', a: '点击编辑问题解答 3' },
                            { q: '点击编辑常见问题 4', a: '点击编辑问题解答 4' },
                            { q: '点击编辑常见问题 5', a: '点击编辑问题解答 5' },
                            { q: '点击编辑常见问题 6', a: '点击编辑问题解答 6' }
                        ],
                        en: [
                            { q: 'Click to edit FAQ Question 1', a: 'Click to edit FAQ Answer 1' },
                            { q: 'Click to edit FAQ Question 2', a: 'Click to edit FAQ Answer 2' },
                            { q: 'Click to edit FAQ Question 3', a: 'Click to edit FAQ Answer 3' },
                            { q: 'Click to edit FAQ Question 4', a: 'Click to edit FAQ Answer 4' },
                            { q: 'Click to edit FAQ Question 5', a: 'Click to edit FAQ Answer 5' },
                            { q: 'Click to edit FAQ Question 6', a: 'Click to edit FAQ Answer 6' }
                        ]
                    };
                    curFaqs = defaultEmptyFaqs[curLang] || defaultEmptyFaqs.en;
                }

                return {
                    title: titleText || (base && curLang === 'en' ? base.title : (curLang === 'en' ? 'Article Title' : '')),
                    ...
                    content: bodyContent || emptyBodyHtml,
                    faqs: curFaqs
                };
            }
        } catch(e) {}
