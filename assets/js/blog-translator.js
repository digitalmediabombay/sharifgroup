...
(function() {
    ...
    var FULL_ARTICLES = {
        'meet-the-team-behind-sharif-group': {
            ...
            'fa': {
                ...
                content: `
                    ...
                    <p>برای هر موکل در گروپ شریف یک مدیر پرونده ارشد تعیین می‌شود تا در تمام مراحل مهاجرت به عنوان نقطه تماس مستقیم شما عمل کند. تیم مشاوره ما چندزبانه بوده و به زبان‌های فارسی، عربی، انگلیسی، روسی، فرانسوی، هندی و اردو مسلط است. ما پیش از پیشنهاد هر برنامه، شرایط خاص خانواده، اهداف تجاری بلندمدت و ملاحظات مالیاتی شما را به دقت ارزیابی می‌کنیم تا مدارک به موقع و با بالاترین استانداردها ثبت گردند.</p>
                ...
                `,
                faqs: [
                    { q: "مشاوران گروپ شریف چه مدارک و صلاحیت‌های رسمی دارند؟", a: "مشاوران ما دارای عضویت رسمی در شورای بین‌المللی مهاجرت سرمایه‌گذاری (IMC) و مجوزهای رسمی املاک از دپارتمان اراضی دبی (RERA) هستند." },
                    { q: "گروپ شریف چگونه محرمانگی اطلاعات موکلان را تضمین می‌کند؟", a: "ما از استانداردهای سختگیرانه رمزنگاری بانکی و پروتکل‌های امنیتی چندلایه برای حفاظت کامل از داده‌های هویتی و مالی شما استفاده می‌کنیم." },
        ...
        'what-is-citizenship-by-investment-a-simple-guide': {
            ...
            'fa': {
                ...
                content: `
                    ...
                    <p>تمامی برنامه‌های ارائه‌شده توسط گروپ شریف بر اساس مصوبات رسمی پارلمان کشورها بوده و تابعیت اعطا شده مادام‌العمر و قابل انتقال به نسل‌های آینده است.</p>
        ...
        'about-sharif-group-who-we-are-and-how-we-help': {
            ...
            'fa': {
                title: 'درباره گروپ شریف: ما چه کسی هستیم و چگونه کمک می‌کنیم',
                content: `
                    <p>گروپ شریف یکی از برجسته‌ترین شرکت‌های مشاوره مهاجرت سرمایه‌گذاری و پیگیری اسناد رسمی است که در منطقه بیزینس بی دبی فعالیت می‌کند. ما به متقاضیان بین‌المللی و خانواده‌هایشان کمک می‌کنیم تا از مسیرهای قانونی به پاسپورت دوم، اقامت طلایی، خریدهای ملکی مطمئن و پذیرش‌های تحصیلی دست یابند.</p>
                    ...
                    <p>گروپ شریف به صورت رسمی با واحدهای دولتی صادرکننده شهروندی در حوزه کارائیب، اروپا و اقیانوس آرام همکاری می‌کند. ما شما را در برنامه‌های دومینیکا، سنت کیتس، آنتیگوا، سنت لوسیا، گرنادا، وانواتو و ویزاهای طلایی پرتغال، یونان، پاناما و امارات همراهی می‌نماییم.</p>
