...
const Settings = {
  ...
  set(data) {
    Store.set(KEYS.SETTINGS, data);
    try { saveData(KEYS.SETTINGS, data); } catch (e) {}
  },
  ...
  async translate(text, targetLang, sourceLang = 'en') {
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (json && json.success && typeof json.translated === 'string' && json.translated.trim()) {
  ...
  homepage: {
    hero: {
      ...
      fa: {
        ...
        headline: 'به شریف گروپ خوش آمدید',
    ...
    services: {
      ...
      pillar_cbi: {
        ...
        items: [
          ...
          { id: 'stkitts', title: 'St. Kitts & Nevis | Passport', desc: 'The oldest and most trusted citizenship by investment program in the world, active since 1984 with dependable asset security.', link: 'programs/citizenshipbyinvestment/stkitts/' },
          { id: 'antigua', title: 'Antigua & Barbuda | Passport', desc: 'The best and most cost-effective passport solution for large families, covering up to four members under one baseline fee.', link: 'programs/citizenshipbyinvestment/antiguaandbarbuda/' },
          { id: 'lucia', title: 'Saint Lucia | Passport', desc: 'Flexible financial options with government-guaranteed bond investments that are 100% refundable after 5 years.', link: 'programs/citizenshipbyinvestment/stlucia/' },
          { id: 'grenada', title: 'Grenada | Passport', desc: 'Powerful second passport providing direct qualification to apply for the USA E-2 Investor Visa to live and conduct business in America.', link: 'programs/citizenshipbyinvestment/grenada/' },
  ...
  citizenship: [
    {
      ...
      fa: {
        ...
        visa_free: '+۱۴۰',
        overview_title: 'بررسی جامع برنامه: راهنمای شریف گروپ',
