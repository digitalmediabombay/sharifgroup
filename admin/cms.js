  ...
  homepage: {
    hero: {
      ...
      fa: {
        ...
        headline: 'به گروپ شریف خوش آمدید',
    ...
    about: {
      ...
      fa: {
        ...
        subheading: 'گروپ شریف',
        p1: 'گروپ شریف یک شرکت مشاوره خصوصی معتبر مستقر در بیزینس بی دبی است. ما به مشتریان و خانواده‌های بین‌المللی در دریافت پاسپورت دوم قانونی، ویزای اقامت، سرمایه‌گذاری املاک لوکس و پذیرش دانشگاه‌های برتر کمک می‌کنیم.',
  ...
  citizenship: [
    {
      ...
      fa: {
        ...
        visa_free: '+۱۴۰',
        overview_title: 'بررسی جامع برنامه: راهنمای گروپ شریف',
